...
{
    public static class D3TournamentIdFilterQuery
    {
        ...
        public static ISpecification<Tournament> GetSingleton(ID3Context d3Context)
        {
            ...
            {
                that = D3Specification.Create<Tournament>(d3Context).CompareFormat(x => x.TournamentId, ComparisonOp.EQUALS, 0, LogicalOp.NONE);
