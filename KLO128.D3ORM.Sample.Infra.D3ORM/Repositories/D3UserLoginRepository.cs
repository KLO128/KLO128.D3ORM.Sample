...
{
    public class D3UserLoginRepository : D3CommonRepository<UserLogin>, IUserLoginRepository
    {
        public D3UserLoginRepository(IDbConnection Connection, ID3Context D3Context) : base(Connection, D3Context)
        {
        }
    }
}
