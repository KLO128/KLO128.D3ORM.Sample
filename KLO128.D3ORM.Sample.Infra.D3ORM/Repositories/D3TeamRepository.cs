...
{
    public class D3TeamRepository : D3AggRootRepository<Team>, ITeamRepository
    {
        public D3TeamRepository(IDbConnection Connection, ID3Context D3Context) : base(Connection, D3Context)
        {
        }
    }
}
