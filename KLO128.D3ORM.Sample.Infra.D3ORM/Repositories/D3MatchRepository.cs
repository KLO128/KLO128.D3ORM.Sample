...
{
    public class D3MatchRepository : D3AggRootRepository<Match>, IMatchRepository
    {
        public D3MatchRepository(IDbConnection Connection, ID3Context D3Context) : base(Connection, D3Context)
        {
        }
    }
}
