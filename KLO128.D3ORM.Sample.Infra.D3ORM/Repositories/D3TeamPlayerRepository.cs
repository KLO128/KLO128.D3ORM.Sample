...
{
    public class D3TeamPlayerRepository : D3CommonRepository<TeamPlayer>, ITeamPlayerRepository
    {
        public D3TeamPlayerRepository(IDbConnection Connection, ID3Context D3Context) : base(Connection, D3Context)
        {
        }
    }
}
