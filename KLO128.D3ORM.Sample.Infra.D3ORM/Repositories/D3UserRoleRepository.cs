...
{
    public class D3UserRoleRepository : D3CommonRepository<UserRole>, IUserRoleRepository
    {
        public D3UserRoleRepository(IDbConnection Connection, ID3Context D3Context) : base(Connection, D3Context)
        {
        }
    }
}
