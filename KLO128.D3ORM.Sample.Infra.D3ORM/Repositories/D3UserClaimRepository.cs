...
{
    public class D3UserClaimRepository : D3CommonRepository<UserClaim>, IUserClaimRepository
    {
        public D3UserClaimRepository(IDbConnection Connection, ID3Context D3Context) : base(Connection, D3Context)
        {
        }
    }
}
