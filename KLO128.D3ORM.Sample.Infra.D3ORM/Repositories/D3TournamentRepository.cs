...
{
    public class D3TournamentRepository : D3AggRootRepository<Tournament>, ITournamentRepository
    {
        public D3TournamentRepository(IDbConnection Connection, ID3Context D3Context) : base(Connection, D3Context)
        {
        }
    }
}
