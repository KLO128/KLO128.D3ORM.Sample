...
{
    public class D3TournamentTeamRepository : D3CommonRepository<TournamentTeam>, ITournamentTeamRepository
    {
        public D3TournamentTeamRepository(IDbConnection Connection, ID3Context D3Context) : base(Connection, D3Context)
        {
        }
    }
}
