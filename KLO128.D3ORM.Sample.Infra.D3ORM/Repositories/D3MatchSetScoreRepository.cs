...
{
    public class D3MatchSetScoreRepository : D3AggRootRepository<MatchSetScore>, IMatchSetScoreRepository
    {
        public D3MatchSetScoreRepository(IDbConnection Connection, ID3Context D3Context) : base(Connection, D3Context)
        {
        }
    }
}
