...
";
	...
	, 4
	, 3
	, '20221031 20:00:00.000'
	, NULL
	, '20221101 00:05:25.000'
	, NULL
);
";
...
ORDER BY [p0].[PlayoffRoundCoupleId], 21 DESC, [m0].[MatchId], 20, 16
...
WHERE
	[m1].[LastChange] >= '20220322 00:00:00.000'
...
WHERE
	[m1].[MatchSetScoreId] IN ( |RANGE| ) AND  ([m1].[LastChange] >= '20220322 00:00:00.000' )
...
";
        ...
        public const string BulkUpdateQuery = @"UPDATE [Team] SET 	[IsActive] = 0 WHERE [RegistrationDate] <= '20120803 00:00:00.000'";
